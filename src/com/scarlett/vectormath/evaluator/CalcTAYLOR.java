	...
	public CalcObject evaluate(CalcFunction function) { //TAYLOR(function, variable, center (default 0), terms (default 10))
		if (function.size() < 2) {
			...
			if (function.size() > 2 && function.get(2).isNumber()) {
				...
				else throw new CalcWrongParametersException("TAYLOR -> 4th parameter syntax");
			}
			...
			else throw new CalcWrongParametersException("TAYLOR -> 3rd parameter syntax");
		}
		else throw new CalcWrongParametersException("TAYLOR -> 2nd parameter syntax");
	}
